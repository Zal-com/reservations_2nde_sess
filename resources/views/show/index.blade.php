        ...
        <div class="flex flex-wrap">
            @foreach($shows as $item)
                <div class="p-4 md:w-1/3 card h-100%">
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 my-2 mx-auto">
                        ...
                        <div class="p-5 m-h-300">
                            ...
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-ellipsis overflow-hidden line-clamp-2">
                                {{$item->description}}
                            </p>
