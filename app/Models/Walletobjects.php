...
class Google_Service_Walletobjects_Media_Resource extends Google_Service_Resource
{
   ...
   * @param Google_UploadPrivateImageRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Walletobjects_UploadPrivateImageResponse
   */
  public function upload($issuerId, Google_Service_Walletobjects_UploadPrivateImageRequest $postBody, $optParams = array())
  {
