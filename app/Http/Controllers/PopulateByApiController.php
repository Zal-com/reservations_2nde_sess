...
class PopulateByApiController extends Controller
{
    public function index()
    {
        $response = Http::withHeaders([
            ...
            'Authorization' => 'Bearer 21abf0e5-2c31-3832-b8d1-60c697f5a664'
        ])->get('https://api.brussels:443/api/agenda/0.0.1/events/category?mainCategory=49&subCategory=50&page=3');
